...
public class Meal {
    ...
    public Meal(String meal_name, MealType meal_type, String image_url, String user_note, double protein_g, double fat_g, double carbs_g, double calorie_kcal, Timestamp meal_time) {
